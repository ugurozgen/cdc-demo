...
| `kafka-ankara`     | ankara — Kafka cluster           | `localhost:9094`  | `kafka-ankara:19092`      |
...
| `pg-source-ankara` | ankara — **PG17 standby** (pg-source-gebze replica, slot sync) | `localhost:5434` | `pg-source-ankara:5432` |
| `pg-target-ankara` | ankara JDBC sink hedefi          | `localhost:5435`  | `pg-target-ankara:5432`   |
| `debezium-ankara`   | ankara Kafka Connect             | `localhost:8085`  | `debezium-ankara:8083`     |
...
| `connectors/sink-jdbc-ankara.json`   | ankara Debezium JDBC sink (pg-target-ankara)             |
